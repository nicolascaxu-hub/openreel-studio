...
async def _tool_content_for_saved_image(
    project_id: str,
    saved: dict[str, Any],
    *,
    label: str,
    source_ref: str,
    note: str,
) -> tuple[tuple[ToolContentPart, ...], tuple[str, ...]]:
    ...
    return (
        (
            ToolContentPart.text_part(text),
            ToolContentPart.image_part(image_url, detail="high"),
        ),
        (ref,),
    )
...
async def edit_image_node(
    ...
    *,
    ...
    if action == "preview":
        ...
        content_parts, content_refs = await _tool_content_for_saved_image(
            project_id,
            saved,
            label="preview",
        ...
        }, content_parts=content_parts, content_refs=content_refs, contains_external_context=True)
